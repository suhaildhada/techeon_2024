      ...
      <div className="flex flex-col md:flex-grow  items-center md:items-stretch bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-4xl  dark:border-gray-700 dark:bg-gray-800">
        ...
        <div className="flex flex-col justify-between p-4 leading-normal">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center justify-center gap-1 max-w-32 p-1 text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-2"
          >
